    ...
    <div class="row">
        ...
        <div class="col-8 d-flex align-items-center justify-content-end gap-3">
            ...
            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                data-bs-target="#modal-add-user"><i class="fa fa-fw fa-plus me-1"></i>Thêm học sinh</button>
                    ...
                    <table class="table table-vcenter">
                        <thead>
                            <tr class="table-col-title">
                                ...
                                <th class="text-center col-sort" data-sort-column="id" data-sort-order="default">Mã học
                                    sinh</th>
                    ...
                    <div class="block-content tab-content">
                        <div class="tab-pane fade fade-up show active" id="them-thu-cong" role="tabpanel"
                            ...
                            <form id="addSvThuCong">
                                <div class="mb-3">
                                    <label for="mssv" class="form-label">Mã học sinh</label>
