            ...
            <div class="content-header">
                <div class="space-x-1 d-flex align-items-center space-x-2 animated zoomInRight">
                    <a class="link-fx fw-bold" href="home">
                        ...
                        <span class="fs-4 text-dual">PNK </span><span class="fs-4 text-primary">Test</span>
                    </a>
                </div>
                <div class="space-x-1">
                            ...
                            <div class="text-center slider-team">
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        href="https://github.com/hieutran4724">
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="https://github.com/hieutran4724.png?size=460" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">Trần Trung Hiếu</p>
                                ...
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        href="https://github.com/hieuvm24">
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="https://github.com/hieuvm24.png?size=460" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">Vũ Minh Hiếu</p>
                                            <p class="fs-sm text-white-75 mb-0">
                                                22010080
                                            </p>
                                        </div>
                                ...
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        href="https://github.com/Hungztv">
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="https://github.com/Hungztv.png?size=460" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">Dương Mạnh Hùng</p>
                                            <p class="fs-sm text-white-75 mb-0">
                                                22010106
                                            </p>
                                        </div>
                                ...
                                <div class="p-3 invisible" data-toggle="appear" data-class="animated flipInX">
                                    <a class="block block-rounded bg-gd-primary text-center"
                                        href="https://github.com/dungtan2576">
                                        <div class="block-content block-content-full bg-gd-sea">
                                            <img class="img-avatar img-avatar-thumb"
                                                src="https://github.com/dungtan2576.png?size=460" alt="">
                                        </div>
                                        <div class="block-content block-content-full bg-black-10">
                                            <p class="fw-semibold text-white mb-0">Nguyễn Tấn Dũng</p>
                                            <p class="fs-sm text-white-75 mb-0">
                                                22010101
                                            </p>
                                        </div>
                        ...
                        <div class="py-3">
                            <blockquote class="blockquote">
                                <p class="px-7 fs-5 text-justify mb-5">Sử dụng nhiều công cụ trong việc dạy học, nhưng PNK Test là công cụ mình yêu thích
                                    ...
                                    nghiệm tốt nhất cho người dùng. Chúc PNK Test ngày càng phát triển và nhiều giáo
                                    viên
                                    sẽ biết đến PNK Test hơn.</p>
                            </blockquote>
                            <div class="d-flex align-items-center justify-content-center">
                                <img class="img-avatar me-4" src="./public/media/photos/avatar0.jpg" alt="">
                                <div class="d-flex flex-column align-items-start">
                                    <div class="mt-2 fw-semibold fs-4">Trần Trung Hiếu</div>
                                    <div class="fs-sm text-muted fs-5">22014072</div>
                                </div>
                            </div>
                        </div>
                        <div class="py-3">
                            <blockquote class="blockquote">
                                <p class="px-7 fs-5 text-justify mb-5">Ứng dụng PNK Test có giao diện trực quan, dễ dùng và có đầy đủ các tính năng phục vụ
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <img class="img-avatar me-4" src="./public/media/photos/avatar0.jpg" alt="">
                                <div class="d-flex flex-column align-items-start">
                                    <div class="mt-2 fw-semibold fs-4">Vũ Minh Hiếu</div>
                                    <div class="fs-sm text-muted fs-5">22010080</div>
                                </div>
                            </div>
                        </div>
                        <div class="py-3">
                            <blockquote class="blockquote">
                                <p class="px-7 fs-5 text-justify mb-5">Nhờ có PNK Test mà tôi đã tiết kiệm được rất nhiều thời gian trong việc quản lý lớp
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <img class="img-avatar me-4" src="./public/media/photos/avatar0.jpg" alt="">
                                <div class="d-flex flex-column align-items-start">
                                    <div class="mt-2 fw-semibold fs-4">Dương Mạnh Hùng</div>
                                    <div class="fs-sm text-muted fs-5">22010106</div>
                                </div>
                            </div>
                        </div>
                        <div class="py-3">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <img class="img-avatar me-4" src="./public/media/photos/avatar0.jpg" alt="">
                                <div class="d-flex flex-column align-items-start">
                                    <div class="mt-2 fw-semibold fs-4">Nguyễn Tấn Dũng</div>
                                    <div class="fs-sm text-muted fs-5">22010101</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row items-push fs-sm border-bottom pt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="fs-sm push">
                            ...
                            P. Nguyễn Trác, Yên Nghĩa, Hà Đông, Hà Nội<br>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <ul class="list list-simple-mini">
                            <li>
                                <a class="fw-semibold" href="https://www.facebook.com/profile.php?id=100022035492127">
